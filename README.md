...
```text
Net Fix-protocol 1.3.1\NetFix_PROTOCOL_1.3.1.exe
```
...
```bash
python -m PyInstaller --clean --noconfirm --distpath "Net Fix-protocol 1.3.1" --workpath "build\NetFix_PROTOCOL_1.3.1" NetFix_PROTOCOL_1.3.1.spec
```
...
```text
NetFix-protocol 1.3.1/   # Current 1.3.1 source/release layout
        |

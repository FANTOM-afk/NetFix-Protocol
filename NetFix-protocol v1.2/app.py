...
class NetFixApp:
    ...
    def _build_ui(self) -> None:
        ...
        self.root = ctk.CTk()
        self.root.title("NET_FIX_PROTOCOL v1.2")
    ...
    def _add_tray(self) -> None:
        try:
            ...
            self._hicon = win32gui.LoadImage(
                self._hinst, icon_path,
                win32gui.IMAGE_ICON, 16, 16, win32gui.LR_LOADFROMFILE
            )
            self._tray_data = (
                self.root.winfo_id(),
                1,
                ...
                self._hicon,
                "NetFix Protocol - Monitoring Active",
                0,
            )
    ...
    def _remove_tray(self) -> None:
        try:
            import win32gui
            if hasattr(self, '_tray_data') and self._tray_data:
